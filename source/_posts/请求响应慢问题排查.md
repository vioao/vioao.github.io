...
![内存状态](https://img-blog.csdn.net/20180418204838496?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTA4NjI3OTQ=/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)

可以看出，内存使用都还算正常，CPU抖动不太正常[问题查看请看另一篇博文-----[定位CPU异常抖动---tomcat热部署的坑](http://blog.vioao.me/定位CPU异常抖动---tomcat热部署的坑)]，但是不太影响系统的文档运行。那么接下来就考虑是数据库方面的问题。于是立刻找了DBA做让其查看对应时段的数据库状态。
## 查看数据库状态
